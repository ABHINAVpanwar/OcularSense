...
model = models.resnet18(pretrained=False)  # Use pretrained=False to avoid loading unnecessary weights
num_features = model.fc.in_features
model.fc = nn.Linear(num_features, 4)  # Set the output layer to match your class count

# Step 2: Load the trained weights
model.load_state_dict(torch.load('C:/Users/Abhinav/OneDrive/Documents/MAJOR PROJECT/Code/ResNet/best_resnet_model.pth'))
